...
struct astar_t {
  ...
  static constexpr bool compare(const as_node_t* const& a,
  ...
  virtual bool node_expand(const as_node_t& in, const waypoint_t& goal) = 0;

  // node heuristic function
  virtual uint32_t node_cost(const waypoint_t& dest, const waypoint_t& pos) const = 0;
